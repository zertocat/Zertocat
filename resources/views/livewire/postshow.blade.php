<section>
    ...
    <div class="text-center pt-16 md:pt-32">
        <p class="text-sm md:text-base text-green-500 font-bold">{{ $post->created_at }}
            <span class="text-gray-900">/</span> Created
        </p>
        <h1 class="font-bold break-normal text-3xl md:text-5xl text-blue-300">{{ $post->title }}</h1>
    </div>
    <!--image-->
    <img class="container w-full max-w-6xl mx-auto bg-white bg-cover mt-8 rounded"
